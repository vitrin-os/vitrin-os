...
- `verbs` uses the bitfield [`vitrin_grant.verb`](./04-vitrin_grant.md#verb)
  ...
  branches were merged, and it is two again now that the core-drawn picker
  serves `designate_file`; both sides carry the marker. The values are **not** consecutive
