...
//! Interface `vitrin_layout_arrange`, version 1.
//!
//! arrangement facet

pub const INTERFACE_NAME: &str = "vitrin_layout_arrange";
pub const INTERFACE_VERSION: u32 = 1;

/// Every request on this interface exercises the grant verb `layout_arrange`.
pub const VERB: &str = "layout_arrange";
...
pub mod requests {
    ...
    pub struct SetFullscreen {
        ...
        pub mode: crate::generated::vitrin_layout_arrange::Mode,
    }
    ...
    impl SetFullscreen {
        ...
        pub fn decode(
            ...
            let mode = crate::generated::vitrin_layout_arrange::Mode::from_wire(
            ...
            Ok((header.object_id, SetFullscreen { mode }))
        }
    }
}
...
impl Mode {
    ...
    pub const ALL: &'static [Mode] = &[Mode::Windowed, Mode::Fullscreen];
    ...
    pub fn from_wire(value: u32) -> Result<Self, crate::error::DecodeError> {
        match value {
            0 => Ok(Mode::Windowed),
            1 => Ok(Mode::Fullscreen),
            _ => Err(crate::error::DecodeError::InvalidEnumValue {
                interface: "vitrin_layout_arrange",
                enum_name: "mode",
                value,
            }),
        }
