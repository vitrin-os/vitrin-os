...
5. The workstreams, as needed: [`10-workstream-spec.md`](10-workstream-spec.md) · [`11-workstream-funding.md`](11-workstream-funding.md) · [`12-workstream-community.md`](12-workstream-community.md) · [`13-workstream-agent-integration.md`](13-workstream-agent-integration.md) · [`14-workstream-session-mode.md`](14-workstream-session-mode.md).
